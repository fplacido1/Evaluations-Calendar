...
private static void comands (Scanner in, SystemClass system, String comm){
    ...
    switch(comm){
        ...
        case EXIT:
        System.out.println(EXIT_MESAGE);
        System.out.println();
...
private static void help(){
    ...
    System.out.println(EXIT + " - " + EXIT_MSG);
}
...
private static void addSchedule(Scanner in, SystemClass system){
    ...
    system.addSchedule(courseName, year, month, day, hour, mins, duration, testName);
...
private static void addDeadline(Scanner in, SystemClass system){ // temos de fazer os checks
    ...
    system.addDeadline(courseName, year, month, day, deadLineName);
